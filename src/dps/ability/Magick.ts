...
const Magicks: Magick[] = [
	...
	{ name: "Fire", license: LicenseByName("Black Magick 1"), ct: 23, at: 0, att: 22, fireDamage: true, },
	{ name: "Fira", license: LicenseByName("Black Magick 5"), ct: 23, at: 0, aoe: 0, att: 67, fireDamage: true, },
	{ name: "Firaga", license: LicenseByName("Black Magick 9"), ct: 23, at: 0, aoe: 0, att: 120, fireDamage: true, },
	{ name: "Thunder", license: LicenseByName("Black Magick 1"), ct: 23, at: 0, att: 23, lightningDamage: true, },
	{ name: "Thundara", license: LicenseByName("Black Magick 6"), ct: 23, at: 0, aoe: 0, att: 68, lightningDamage: true, },
	{ name: "Thundaga", license: LicenseByName("Black Magick 9"), ct: 23, at: 0, aoe: 0, att: 122, lightningDamage: true, },
	{ name: "Blizzard", license: LicenseByName("Black Magick 2"), ct: 23, at: 0, att: 25, iceDamage: true, },
	{ name: "Blizzara", license: LicenseByName("Black Magick 6"), ct: 23, at: 0, aoe: 0, att: 70, iceDamage: true, },
	{ name: "Blizzaga", license: LicenseByName("Black Magick 10"), ct: 23, at: 0, aoe: 0, att: 125, iceDamage: true, },
	{ name: "Aero", license: LicenseByName("Black Magick 4"), ct: 23, at: 0, aoe: 0, att: 51, windDamage: true, },
	{ name: "Aeroga", license: LicenseByName("Black Magick 8"), ct: 23, at: 0, aoe: 0, att: 103, windDamage: true, },

	{ name: "Aqua", license: LicenseByName("Black Magick 3"), ct: 23, at: 0, att: 37, waterDamage: true, },
